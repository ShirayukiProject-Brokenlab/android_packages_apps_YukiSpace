...
public final class Utils {
    private static final String TAG = "YukiUtils";
    ...
    private static final String MAGISK_DELTA = "io.github.huskydg.magisk";
    ...
    public static boolean isRooted(Context context) {
        ...
        try {
            PackageManager pm = context.getPackageManager();
            if (isPackageInstalled(context, MAGISK_DELTA, false) &&
                    isSystemPackage(pm, pm.getPackageInfo(MAGISK_DELTA, 0))) {
                return true;
            }
        } catch (NameNotFoundException e) { /* Do nothing */ }
