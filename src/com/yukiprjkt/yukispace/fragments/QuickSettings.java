...
import com.yukiprjkt.yukispace.preferences.SecureSettingMasterSwitchPreference;
import com.yukiprjkt.yukispace.preferences.SystemSettingEditTextPreference;
...
public class QuickSettings extends DashboardFragment implements
    ...
    protected int getPreferenceScreenResId() {
        return R.xml.yuki_settings_quicksettings;
    }
    ...
    public void onCreate(Bundle icicle) {
        ...
        if (footerString != null && !footerString.isEmpty())
            ...
            mFooterString.setText("#yukiprjkt");
            Settings.System.putString(resolver,
                    Settings.System.QS_FOOTER_TEXT_STRING, "#yukiprjkt");
        }
    }
    ...
    public static final BaseSearchIndexProvider SEARCH_INDEX_DATA_PROVIDER =
            new BaseSearchIndexProvider(R.xml.yuki_settings_quicksettings);
}
